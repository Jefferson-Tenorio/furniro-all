...
export default class AuthFactory {
  static createController(): AuthController {
    ...
    const expiresInMs = parseInt(process.env.JWT_EXPIRES_IN_MS || "3600000", 10);
    ...
    const authService = new AuthService(userRepository, jwtService, tokenDenylistRepository);
