...
export function Login() {
  ...
  return (
    <>
      <PageBanner breadcrumbCurrent="Login" breadcrumbHome="Home" title="Login" />
      <div className="flex justify-center items-center py-20 px-4">
        <form onSubmit={handleSubmit(onSubmit)} className="w-full max-w-md bg-white p-8 shadow-md rounded-md">
          ...
          <p className="mt-4 text-center text-sm text-gray-600">
            Don't have an account? <Link to="/register" className="text-[#B88E2F] underline">Register</Link>
          </p>
        </form>
      </div>
    </>
